...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="home.guru.php">HOME</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
            ...
            <a type="button" class="btn btn-secondary" href="galeri-guru.php" style="margin-left:5px;">GALERI</a>        
    </div>
    </div>
    <form>
         <a type="button" class="btn btn-danger" href="home.guru.php" style="margin-left:5px;">Log out</a>
    </form>  
  </div>
</nav>
<?php
include "session.guru.php";
include "koneksi.php";
?>
