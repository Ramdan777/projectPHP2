...
<div id="login-page">
    ...
    <form class="form-login" method="post" action="input.data-guru_aksi.php">
        <h2 class="form-login-heading"> <span class="glyphicon glyphicon-lock"></span> Tambah Data Guru </h2>
        <center>
        ...
        <div class="login-wrap">
          <input name="nip" id="nip" type="input" class="form-control" autocomplete="off" placeholder="Masukan nip" required autofocus>
          <br />
          <input name="nama" id="nama" type="input" class="form-control" autocomplete="off" placeholder="Masukan Nama" required>
          <br />
          <input name="jabatan" id="jabatan" type="input" class="form-control" autocomplete="off" placeholder="Masukan Jabatan" required>
          <br />
          <input name="kode" id="kode" type="input" class="form-control" autocomplete="off" placeholder="Masukan Kode" required>
          <br />
          <button class="btn btn-lg btn-info btn-block" type="submit">Simpan Data</button>
          <hr>
          <div class="login-social-link centered">
                        <a href="data_guru.php" class="btn btn-success" type="submit"><i class="fa fa-user"></i> KEMBALI KE DATA GURU </a>
                    </div>
