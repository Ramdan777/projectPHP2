...
<div id="login-page">
    ...
    <form class="form-login" method="post" action="input.data-nilai_aksi1.php">
        ...
        <div class="login-wrap">
          ...
          <br />
          <input name="nilai1" id="nilai1" type="input" class="form-control" autocomplete="off" placeholder="Masukan Nilai Pengetahuan" required>
          <br />
          <input name="nilai2" id="nilai2" type="input" class="form-control" autocomplete="off" placeholder="Masukan Nilai Keterampilan" required>
          <br />
          <button class="btn btn-lg btn-info btn-block" type="submit">Simpan Data</button>
          <hr>
          <div class="login-social-link centered">
                        <a href="nilai_siswa.admin.php" class="btn btn-success" type="submit"><i class="fa fa-user"></i> KEMBALI KE NILAI SISWA </a>
                    </div>
