...
<div id="login-page">
    ...
    <form class="form-login" method="post" action="input.data-siswa_aksi.php">
        <h2 class="form-login-heading"> <span class="glyphicon glyphicon-lock"></span> Tambah Data Siswa </h2>
        <center>
        ...
        <div class="login-wrap">
          ...
          <br />
          <input name="tanggal_lahir" id="tanggal_lahir" type="date" class="form-control" autocomplete="off" placeholder="Masukan Tanggal Lahir" required>
          <br />
