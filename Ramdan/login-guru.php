        ...
        <div class="container">
            ...
            <form class="form-login" method="post" action="">
                ...
                <div class="login-wrap">
                    ...
                    <br />
                    <input name="kode" id="kode" type="password" class="form-control" autocomplete="off" placeholder="Masukan Kode" required>
                    <br />
...
if(isset($_POST['proseslog'])) {
    $sql = mysqli_query($koneksi, "select * from guru where nama = '$_POST[nama]'
    and kode = '$_POST[kode]'");
    ...
    if($cek > 0 ) {
        ...
        echo "<meta http-equiv=refresh content=1;URL='login-guru.php'>";
    }
}
