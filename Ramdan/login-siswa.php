	  ...
	  <div id="login-page">
	  	<div class="container">
    		  ...
    		  <form class="form-login" method="post" action="">
		        <h2 class="form-login-heading"> <span class="glyphicon glyphicon-lock"></span> LOGIN SISWA</h2>
                <center><h5> <span class="glyphicon glyphicon-qrcode"></span> Sistem Informasi Nilai Siswa <span class="glyphicon glyphicon-qrcode"></span></h5></center>
		        <div class="login-wrap">
		            <input name="nama" id="nama" type="input" class="form-control" autocomplete="off" placeholder="Masukan Nama" required  autofocus>
                    <br />
                    <input name="nisn" id="nisn" type="password" class="form-control" autocomplete="off" placeholder="Masukan NISN" required>
                    <br />
...
if(isset($_POST['proseslog'])) {
    $sql = mysqli_query($koneksi, "select * from siswa where nama = '$_POST[nama]'
    and nisn = '$_POST[nisn]'");
    ...
    if($cek > 0 ) {
        ...
        echo "<meta http-equiv=refresh content=1;URL='login-siswa.php'>";
    }
}
